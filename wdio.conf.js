...
exports.config = {
  ...
  waitforTimeout: varTimeOut,
  //
  // Default timeout in milliseconds for request
  // if Selenium Grid doesn't send response
  connectionRetryTimeout: varTimeOut,
  //
  ...
  // reporters: ["dot", "allure", 'allure-addons'],
  // reporterOptions: {
  //   'allure-addons': {
  ...
  // 'allure-addons': { outputDir: 'allure-results', debug: true, debugSeleniumCommand: true } },
  mochaOpts: {
    ui: "bdd",
    timeout: varTimeOut
  },
  jasmineNodeOpts: {
    defaultTimeoutInterval: varTimeOut
  },
